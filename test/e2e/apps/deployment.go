...
var _ = SIGDescribe("Deployment", func() {
	...
	*/
	framework.ConformanceIt("should run the lifecycle of a Deployment", func(ctx context.Context) {
		...
		framework.ExpectNoError(err, "failed to dc.Resource.Namespace.Patch")
	...
	*/
	framework.ConformanceIt("should validate Deployment Status endpoints", func(ctx context.Context) {
		...
		framework.ExpectNoError(err, "failed to e2edeployment.WaitForDeploymentRevisionAndImage")
		...
		framework.ExpectNoError(err, "failed to dClient.Get")
...
func stopDeployment(ctx context.Context, c clientset.Interface, ns, deploymentName string) {
	...
	framework.ExpectNoError(err, "failed to e2eresource.DeleteResourceAndWaitForGC")
...
func testDeleteDeployment(ctx context.Context, f *framework.Framework) {
	...
	framework.ExpectNoError(err, "failed to testutil.GetNewReplicaSet")
...
func testRollingUpdateDeployment(ctx context.Context, f *framework.Framework) {
	...
	framework.ExpectNoError(err, "failed to testutil.GetOldReplicaSets")
...
func testRecreateDeployment(ctx context.Context, f *framework.Framework) {
	...
	framework.ExpectNoError(err, "failed to watchRecreateDeployment")
}
...
func testDeploymentCleanUpPolicy(ctx context.Context, f *framework.Framework) {
	...
	framework.ExpectNoError(err, "failed to c.CoreV1.Pods.Watch")
	go func() {
	...
	framework.ExpectNoError(err, "failed to waitForDeploymentOldRSsNum")
}
...
func testRolloverDeployment(ctx context.Context, f *framework.Framework) {
	...
	framework.ExpectNoError(err, "failed to e2ereplicaset.WaitForReadyReplicaSet")
	...
	framework.ExpectNoError(err, "failed to waitForDeploymentUpdatedReplicasGTE")
	...
	framework.ExpectNoError(err, "failed to checkDeploymentRevisionAndImage")
	...
	framework.ExpectNoError(err, "failed to c.AppsV1.ReplicaSets.Get")
	...
	framework.ExpectNoError(err, "failed to waitForObservedDeployment")
	...
	framework.ExpectNoError(err, "failed to waitForDeploymentCompleteAndCheckRolling")
...
func testIterativeDeployments(ctx context.Context, f *framework.Framework) {
	...
	for i := range iterations {
		...
		default:
			...
			framework.ExpectNoError(err, "failed to c.CoreV1.Pods.List")
	...
	framework.ExpectNoError(err, "failed to waitForDeploymentWithCondition")
}
...
func testDeploymentsControllerRef(ctx context.Context, f *framework.Framework) {
	...
	framework.ExpectNoError(err, "failed to checkDeploymentReplicaSetsControllerRef")
	...
	framework.ExpectNoError(err, "failed to orphanDeploymentReplicaSets")
...
func testProportionalScalingDeployment(ctx context.Context, f *framework.Framework) {
	...
	framework.ExpectNoError(err, "failed to intstr.GetScaledValueFromIntOrPercent")
	...
	framework.ExpectNoError(err, "failed to e2ereplicaset.WaitForReplicaSetTargetAvailableReplicas")
	...
	framework.ExpectNoError(err, "failed to waitForReplicaSetTargetSpecReplicas")
	...
	framework.ExpectNoError(err, "failed to waitForReplicaSetDesiredReplicas")
...
func testRollingUpdateDeploymentWithLocalTrafficLoadBalancer(ctx context.Context, f *framework.Framework) {
	...
	framework.ExpectNoError(err, "failed to jig.GetEndpointNodeNames")
