...
var _ = SIGDescribe("LimitRange", func() {
	...
	*/
	framework.ConformanceIt("should create a LimitRange with defaults and ensure pod has those defaults applied.", func(ctx context.Context) {
		...
		framework.ExpectNoError(err, "failed to f.ClientSet.CoreV1.LimitRanges.Create")
		...
		framework.ExpectNoError(err, "failed to f.ClientSet.CoreV1.LimitRanges.Get")
		...
		framework.ExpectNoError(err, "failed to equalResourceRequirement")
		...
		framework.ExpectNoError(err, "failed to f.ClientSet.CoreV1.LimitRanges.Update")
		...
		framework.ExpectNoError(err, "failed to f.ClientSet.CoreV1.LimitRanges.Delete")
