...
var _ = SIGDescribe("CronJob", func() {
	...
	*/
	...
	ginkgo.It("should remove from active list jobs that have been deleted", func(ctx context.Context) {
		...
		framework.ExpectNoError(e2eresource.DeleteResourceAndWaitForGC(ctx, f.ClientSet, batchinternal.Kind("Job"), f.Namespace.Name, job.Name), "failed to e2eresource.DeleteResourceAndWaitForGC")
	...
	*/
	framework.ConformanceIt("should support CronJob API operations", func(ctx context.Context) {
		...
		framework.ExpectNoError(err, "failed to cjClient.Create")
		...
		framework.ExpectNoError(err, "failed to cjClient.Get")
		...
		framework.ExpectNoError(err, "failed to cjClient.Patch")
		...
		framework.ExpectNoError(err, "failed to cjClient.Update")
		...
		framework.ExpectNoError(err, "failed to cjClient.UpdateStatus")
		...
		framework.ExpectNoError(err, "failed to cjClient.Delete")
