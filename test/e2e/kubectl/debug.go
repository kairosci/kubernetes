...
`), os.FileMode(0755)), "creating a custom.yaml in temp directory")
			...
			framework.ExpectNoError(e2epod.WaitForContainerRunning(ctx, c, ns, debugPodName, "debugger", framework.PodStartShortTimeout), "failed to e2epod.WaitForContainerRunning")
...
`), os.FileMode(0755)), "creating a custom.yaml in temp directory")
			...
			framework.ExpectNoError(e2epod.WaitForContainerRunning(ctx, c, ns, "my-debugger", "debugger", framework.PodStartShortTimeout), "failed to e2epod.WaitForContainerRunning")
