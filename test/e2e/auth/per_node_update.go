...
var _ = SIGDescribe("ValidatingAdmissionPolicy", func() {
	...
	g.It("can restrict access by-node", func(ctx context.Context) {
		...
		framework.ExpectNoError(err, "failed to f.ClientSet.AdmissionregistrationV1.ValidatingAdmissionPolicies.Create")
		...
		framework.ExpectNoError(err, "failed to f.ClientSet.AdmissionregistrationV1.ValidatingAdmissionPolicyBindings.Create")
		...
		framework.ExpectNoError(err, "failed to nodeScopedClient.AuthenticationV1.SelfSubjectReviews.Create")
		...
		framework.ExpectNoError(err, "failed to nodeScopedClient.CoreV1.ConfigMaps.Create")
		...
		framework.ExpectNoError(err, "failed to nodeScopedClient.CoreV1.ConfigMaps.Update")
		...
		framework.ExpectNoError(err, "failed to nodeScopedClient.CoreV1.ConfigMaps.Delete")
		...
		framework.ExpectNoError(err, "failed to f.ClientSet.CoreV1.ServiceAccounts.CreateToken")
		...
		framework.ExpectNoError(err, "failed to serviceAccountClientWithoutNodeClaim.AuthenticationV1.SelfSubjectReviews.Create")
